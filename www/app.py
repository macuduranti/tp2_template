...
@app.route('/ultima/')
def ultima():
	sample = db.get_lastsample() # Ejecuta metodo get, devolviendo la ultima muestra
...
def promedios():
	...
	pprom = 0
	wprom = 0
	samples = db.get_10samples() # Ejecuta metodo get, devolviendo las ultimas 10 muestras
	length = len(samples) 
